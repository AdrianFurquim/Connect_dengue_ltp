...
import edu.ifsp.connectdengue.connectdengueapi.security.service.MinhaUsuarioDetailsService;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(
                        authorize -> authorize.requestMatchers(HttpMethod.POST, "/dengue/relatos/inserir")
                                .authenticated()
